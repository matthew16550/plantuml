...
public class PngWriter {
	...
	public PngWriter creationMetadata() throws IIOInvalidTreeException {
		final List<String> metadata = new ArrayList<>(InterestingProperties.interestingProperties());
		metadata.add("Timestamp: " + DATE_FORMAT.format(new Date()));
		return text(CREATION_METADATA_TAG, multilineString(metadata));
	}
}
