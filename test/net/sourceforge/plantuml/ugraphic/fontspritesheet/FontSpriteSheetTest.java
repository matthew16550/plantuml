...
class FontSpriteSheetTest {
	...
	void test_drawing(FontSpriteSheet sheet) {
	...
	void test_font_variations(int size) {
		approve(
				"@startuml",
				"!pragma testing_font",
				"!theme plain",
	...
	@Test
	@Disabled("Non trivial to support Wire Diagrams because WireDiagram.print() uses StringBounder")
	...
	@Test
	void test_sprite_sheet_read_write() throws Exception {
